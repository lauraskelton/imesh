...
@interface SSShareMessageManager ()
...
- (id)init {
	if ((self = [super init])) {
        ...
        self.peripheralManager = [[CBPeripheralManager alloc] initWithDelegate:self queue:nil options:@{ CBPeripheralManagerOptionRestoreIdentifierKey: @"a258d540-0072-11e4-9191-0800200c9a66" }];
...
- (void)peripheralManager:(CBPeripheralManager *)peripheral
    ...
    state[CBPeripheralManagerRestoredStateAdvertisementDataKey];
    
    NSLog(@"peripherals: %@", advertisements);
}
